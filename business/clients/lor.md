...
- Quiet Confidence tone of voice
- Demographic-differentiated messaging architecture
- Global Social Media Blueprint v8 (43 pages, £12,500/month retainer proposal pending)
- Assembly Specialist campaign architecture (V6)
...
### Tier 2 (senior / strategic)

| Name | Email | Role |
|---|---|---|
| **Korena Flanagan** | kflanagan@laingorourke.com | Head of Corporate Affairs. Senior sponsor. Approved Blueprint. Chases AP. |
| **Vicki Locke** | VLocke@laingorourke.com | Corporate Affairs. Met for lunch (180 House). |
| **Joella Lowe** | JoellaLowe@laingorourke.com | Corporate Affairs coordination. Workshop logistics. |

### Tier 3

| Name | Email | Context |
|---|---|---|
| Clare Allen | (no email on file) | Head of Future of Work. Assembly Specialist budget holder. |
| Sue Smith | susmith@laingorourke.com | Hinkley Point (Korena intro). |
...
- Trudi Williams trudi.williams@emperor.works (Emperor, brand/design)
- Miles Wratten Miles.Wratten@emperor.works (Emperor)
...
**LOR is back.** Kerri reappeared after ~2 weeks silent (slammed, away a week, not reading email or folder notifications, NOT a cooling signal). **Early Talent campaign confirmed: "we are definitely going with the early talent stuff."** Resolves the "LOR going cold post-AS" watch.

**Budget — RESOLVED (Harrison, strategic).** Deliberately lowered from the £20,250 draft (too high). Deck lands at **~£15k**, presenting **~£14k** verbally; line-manager filming stays SEPARATE. Still strong money for the scope. **Consistency watch:** said "£12.5k" loosely in the 9 June call, so make the deck number and the Friday verbal match (~£14-15k) so Kerri doesn't see the figure tick up from what she heard.

**Theme:** "More than you think" (evolves last year's "Expect to be surprised"). Wider lens this year — every early-careers pathway and discipline (existing people, apprentices, older gen, youngest), not just apprenticeships. Pillars sketched: the role you didn't picture / who you'll work for / find your route / real projects, real impact / day-in-the-life / education pieces.

**Kerri's key add — "Quality, not quantity."** Last year = thousands of CVs to sift. This year they want fewer, better applicants. Address through content: be explicit about what they're looking for, tell the story. She wants this principle baked into the plan. ACTION: add a quality-not-quantity statement to the deck.

**Channels:** LinkedIn = PRIMARY (savable carousels, ghostwritten posts from internal employees, qualified grads not just school leavers). Instagram/reels = discovery + numbers, less polished. TikTok = watching brief only (no launch; Kerri put off that an ad account now needs a profile). Metrics: LinkedIn clicks, Meta CTR, short-form completion; targets from last year's CTRs.

**Timeline:** June–Aug warm-up (focus current cohorts/apprentices, NO "roles go live" messaging yet) → late Aug/early Sept "roles going live soon" → roles/chamber open October. Shot + edited mid-July, push from August. Role-open sequence (Kerri to confirm): summer industrial placements + grads open Sept; professional apprenticeships Oct; trades ~Feb.

**Shoot days:** up to 4 in the plan. **Line managers:** film ONCE, dual-purpose — internal comms piece + external testimonial/ads ("why come work for us"). Build dual-purpose questions into the shoot.

**Near-term (current cohort):** newsletters June/July/Aug for the Sept-starting cohort (recruited last Sept, start this Sept) to keep them warm. Internal push; some filming dual-purpose. AS = paused/quiet, Sarah keeping content ready; Harrison's ghostwritten posts/carousels sitting unseen in the folder ("massive bank there now").

**Widening:** Kerri meets Eve (general recruitment) Thu; internal roadshows running, external rollout TBD. More scope likely.

**Next actions:**
- **Harrison → send Kerri the ET deck + content ideas FIRST THING Wed 10 June.** Only to Kerri (not Emma yet). Add the quality-not-quantity statement first. She reviews before Friday.
- **Friday 11:00 call** with Kerri (she is booking it) to walk the deck.
- Later: brainstorm/review session with **Emma** (review last year, what worked, align direction).
- Kerri to confirm role-open sequence + Eve/general-recruitment needs; to share Adam's grad videos (pitch-level reference).

Relationship warm: Kerri apologetic, "you are making my life easier, thank you." Reinforces the comms read (doesn't read email/notifications) → weekly digest + just-ping-her is fine.

**Assembly Specialist Recruitment — winding down**
- 101 applications in. 5+5 target (5 internal, 5 external) effectively hit. Claire very happy. Assessment centre ran 20 May.
- Phase moving to "keep warm": welcome posts for new cohort as Sarah signals, lower cadence through June-July, ramp back up for next campaign.
- Queued and not yet sent to Kerri: DfMA education carousel (how-building-gets-built, lands as standalone or rolled into next campaign) + a couple of ghostwritten leader posts (no specific name attached, available for Vitalius/Claire/whoever).
- Annual report this year covers 70/60/30 (DfMA narrative) — ghostwritten posts can be scheduled to tie into that. Harrison to send across, Kerri to schedule.
- 50% balance on the AS £12k still open. Agreed to charge against same PO as posts ship in May/June, close out and reopen for next campaign cycle.

**Early Talent 2026 — kicking off**
- Brief received 20 May. Emma Simpson is Early Talent lead (joined Oct last year, wants a planned campaign this time, opposite of last year's rushed start).
- Scope: Day in the Life shorts, key roles spotlight, external line manager interviews ("Paul, 12 grads in 3 years"), warm-up content under "what's your next move?" angle, careers fair plug-ins.
- Separate internal workstream: line manager training pack — first HWL high-production internal piece for LOR. Adam captures local Dartford managers, Harrison spec + edit + selective filming.
- Timeline: applications open September, warm-up posts from June. 4-month active runway.
- TikTok decision: no. Emma's call, Kerri agrees, HWL agrees. Watching-eye through campaign.
- Quote: £18,500 external + £1,750 internal = **£20,250 total**, 50/50 split, travel at cost. Quote drafted in `campaigns/lor-early-talent-2026.md`. Email parked in capture awaiting Harrison send.
- Dependencies: Emma's interview questions doc + her previous-company DITL inspo (both off Teams chat, Kerri sharing).

**Annual Report social — pending**
- LOR has an agency doing the annual report. Last year they did some social assets, Kerri prescribed. This year Kerri will loop Harrison into the brainstorm — even if it's a social-light convo. No action until Kerri pulls trigger.
- Last year metrics: 5,000+ downloads on annual report, Kyle ghostwritten post performed well. Room to improve cadence and channel mix.

**Strategy Launch (Krina) — dormant**
- No movement. Krina replied ~7 May acknowledging, channel kept open. Don't chase before mid-June.

**Podcast editing**, ongoing as Adam sends.

**Amanda Thompson, Ellison Oxford comms**
- 5 May enquiry: precast beam film (Leicester / CEMC / Oxford). Pulled back 19 May, going back to drawing board, June call to discuss direction, may outsource to a production company.
- New ask 19 May: day rate for "Ellison in Action" interview series. Reply sent 19 May with HWL Studio positioning, rates quoted: **£950/day on-location** (travel from Hackney incl.) and **£550/day editing** or per-clip quote.
- Offered call to plan first piece together once June schedule lands.
...
- LOR Jan + Feb £8,237.50 landed 1 Apr.
- Watch: V8 Blueprint to Korena + Sarah Conway sent 20 Apr, 9 days no response. Nudge if cold by Fri 1 May.
