# Campaign, London Golf Club Outreach (WAVE 1 ARCHIVE)

**Status: CLOSED 2 Jul 2026. Superseded by `campaigns/golf-clubs.md` (v2 fresh restart, Harrison's call).** Kept for history: the Wave 1 sent log, the St George's Hill thread, and the post-mortem. The 6 breakup drafts staged 9 June in Gmail are ABANDONED, do not send them. campaign-chaser: skip this file, chase v2 instead.

**Post-mortem (2 Jul, from Gmail ground truth):** 7 sends on 5 May from harrison@hwlstudio.com. 1 reply: St George's Hill, same day, polite no, door open post-course-works (tickle Q2 2027, carried into v2). The 6 that ghosted were all sent to generic inboxes (info@/reception@/golf@). The 1 that replied went to four NAMED people at personal addresses. FU1/FU2 never fired (runner quoting bug). Lessons carried into v2: named humans only, follow-ups must actually fire, drafts expire if unsent 48h.

**Original header:** active. Wave 1 of 7 sent 5 May 2026 (post council review). Awaiting reply. Wave 2 (11 emails) still to draft + send.
