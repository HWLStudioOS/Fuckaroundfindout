---
plan: Project 32 / 20, block 1
status: ACTIVE BIBLE
athlete: Harrison Living
...
Starting point, 15 July 2026:

- Body mass: approximately 87 kg.
- Waist: 34 inches.
- Garmin VO2max: approximately 45.
- Historical PBs, not current training loads: squat 145 kg, bench 110 kg, deadlift 180 kg.
- Current recovery: D+4 after a hot 50K. Right foot pain 3/10 with bruising almost cleared and limp nearly zero. Quad and upper hip-flexor soreness 2-3/10. No swelling, Achilles pain, calf pain, shin pain, knee pain, ITB pain, hip-joint pain, back pain, urine change or weakness.

Block outcomes:

- Move the waist towards 32 inches.
- Lose roughly 4.5-6.5 kg without sacrificing the training response. About 81-83 kg is a sensible first-block finish. Eighty kilograms is possible, not compulsory.
- Rebuild useful squat, bench and deadlift strength without true 1RM testing.
- Give chest and delts the highest hypertrophy volume, then arms and abs.
- Run a baseline 5K in week 4, a B-race in week 8 and an A-race in week 12.
- Improve easy pace at the same heart rate and effort. Sub-6:00/km is an output, not a pace to force.

Sub-20 means 4:00/km. The week-4 test establishes how many blocks that target needs.

## What changed

The first version was too conservative. It treated a day-nine return as a rule and delayed useful upper lifting because the foot was not ready for impact.

That is not what the evidence supports. A randomised marathon study found that easy running from 48 hours did not worsen recovery through day eight. It does not prove every ultrarunner should run at 48 hours, but it removes the basis for a universal day-nine ban. Harrison's local foot symptoms still control impact. They do not automatically prohibit supported upper training.

## Priority order

1. Respect the focal foot signal and systemic red flags.
2. Start useful strength work now.
3. Preserve the running base and reintroduce quality progressively.
4. Lose fat slowly enough to retain strength, sleep and run quality.
5. Bias hypertrophy towards chest and delts.
6. Build movement skill without creating a second conditioning programme.

# Ramp, 15-26 July

This is a real training microcycle, not dead time.

| Date | Session | Exact prescription | Gate |
|---|---|---|---|
| Wed 15 Jul | Walk, completed | 30 minutes easy. | Foot remains an impact red light at the reported 3/10. |
| Thu 16 Jul | Upper reset | Incline DB press 3x8, chest-supported row 3x10, seated DB press 2x8, pulldown 2x10, lateral raise 3x15, curl 2x12, pressdown 2x12. RIR 4. 45-55 minutes. No leg drive or finisher. | Normal urine, no systemic weakness or illness. Foot pain does not bar supported upper work. |
| Fri 17 Jul | Return run 1 | Flat 25 minutes at RPE 2-3. Optional 4x5 minutes run with 1 minute walk. No pace target. | First 10 steps and normal walking 0-1/10. No swelling, limp or focal bony tenderness. Twenty single-leg calf raises and 10 small hops remain 0-1/10. Stop above 1/10 or for gait change. If failed, bike 40 minutes easy. |
| Sat 18 Jul | Lower reset | Leg press 2x8, RDL 2x8, hamstring curl 2x10, supported split squat 2x8 per side, seated soleus 2x12, cable crunch 2x12. RIR 4. | Friday response is unchanged at two hours and next morning. Skip split squat and calf work if the foot is not quiet. |
| Sun 19 Jul | Easy run 2 | 35-40 minutes flat and conversational. | Foot 0-1/10 with normal gait. |
...
Run only when all relevant items pass:

1. First 10 morning steps and normal walking are 0-1/10.
2. No swelling, visible limp, protective gait or focal bony tenderness.
3. The completed 30-minute walk caused no later increase.
4. Twenty controlled single-leg calf raises per side remain 0-1/10.
5. Ten small hops remain 0-1/10.
6. Running pain stays 0-1/10 with no gait change.
7. Symptoms remain unchanged two hours later and next morning.

Focal bony tenderness, renewed swelling, worsening bruising or pain on hopping that does not settle warrants sports-physio or medical assessment.

## Strength clearance

- Supported upper work can proceed when Harrison is systemically well, even when impact is not cleared.
- Loaded lower work needs normal walking, no offloading and pain no higher than 1/10 in the chosen pattern.
- The first lower exposures use two work sets and RIR 3-4.
- Historical PB percentages are not used.

## Traffic light

| Status | Criteria | Action |
|---|---|---|
| Green | Local pain 0-1/10, no swelling or limp, normal gait, no illness. | Complete the prescription. |
| Amber | Local pain 2/10, DOMS above 4/10, sleep below 6.5 hours, or a clear recovery-trend deterioration. | Remove intensity and cut sets or duration about 30%. |
| Red | Pain at least 3/10, swelling, limp, focal bony pain, illness, severe weakness or dark urine. | No impact or loaded lower work. Supported upper may proceed only if systemically well. |
...
3. Seated DB overhead press, 3x6-10.
4. Chest-supported row, 3x8-12.
5. Cable fly, 3x10-15.
6. Cable or DB lateral raise, 4x12-20.
7. Rear-delt cable fly, 3x12-20.
...
5. Cable or DB lateral raise, 3x12-20.
...
3. Machine chest press or weighted dip, 3x8-12.
4. Neutral-grip lat pulldown, 3x8-12.
5. Cable or DB lateral raise, 3x12-20.
6. Seated soleus raise, 3x10-15.
7. Hammer curl, 2x8-15.
8. Overhead cable triceps extension, 2x8-15.
9. Cable crunch or hanging knee raise, 3x8-15.

At full volume this provides about 14 direct chest sets, 10 lateral-delt sets plus pressing, three rear-delt sets, 5 direct biceps sets and 5 direct triceps sets. Lower-body volume stays useful but controlled.

## Progression

- First exposure: select a load that honestly leaves the prescribed RIR.
...
## Evidence-led elements

- Progressive resistance training.
- Foot-core work.
- Heavy calf and soleus work.
- Progressive knee and hip loading.
- Later low-dose plyometrics for running economy, only after the foot is fully quiet.
- Full-range strength work where positions remain controlled.

## Ido-inspired elements

- Passive and active hanging.
- Deep-squat and shin-box accumulation.
- Bear, crab and ape locomotion.
- Technical stand-ups, rolls and floor transitions.
- Short improvised flows.

These build movement vocabulary, coordination and enjoyment. They are not presented as post-ultra recovery treatments, injury prevention or VO2 work.
...
- Protein: 190 g daily.
- Initial weekly calorie average: about 2,607 kcal, cycled by training demand.
- Target loss: 0.3-0.65 kg per week.
- Hold the first targets for 14 complete days, then adjust by 150 kcal using seven-day weight trends, waist and performance.
...
The project score is out of 100:

- Run completion: 25.
- Lift-set completion: 25.
- Seven protein days: 20.
- Seven morning weigh-ins: 10.
- Three movement days of at least 10 minutes: 10.
- Sunday review: 10.

Eighty or higher is a green week. Missed work is logged, not repaid.

Book these after confirming travel:

- B-race: [Queen Elizabeth Olympic Park 5K, 19 September 2026](https://www.runthrough.co.uk/event/queen-elizabeth-olympic-park-5k-10k-september-2026).
- A-race: [Lee Valley VeloPark 5K, 17 October 2026](https://www.runthrough.co.uk/event/lee-valley-velo-park-october-2026).
