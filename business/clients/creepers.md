...
- `@creepersinstallation` has no installation-only post newer than the 30 July hedge before-and-after. The 3 August Wentworth carousel appears on both grids but was published by the nursery account. Today's active post is the six-slide `The Rootball Check` 37°C aftercare carousel in `business/clients/creepers-heat-aftercare-post-2026-08-13/`. Its canonical editable source is [section 09B in the Creepers Figma file](https://www.figma.com/design/WGdYv8RFPgduHJyuu8WJni/Creepers?node-id=453-2) (`453:2`). V2 uses only Harrison's Creepers Surrey imagery, with no Landform or Hatchford material. Nothing has been posted or sent.
