...
First read capture/inbox.md and content/pipeline.md for Harrison-authored substance: his Telegram replies, voice-note transcripts, anything in his own words. If the bank holds unshaped substance, that is your material. If the bank is empty, do NOT look for topics; switch to interview mode per agents/form-lab.md: ask ONE question about something Harrison actually lived this week, drawn from this-week.md, agents/_log.md and capture/inbox.md. The question elicits his account in his own words and never assigns a topic, angle or content idea. Check the last fortnight of agents/outbox/form-lab-*.md and do not repeat a question. Nothing on family, health or grief unless Harrison raised it himself in recent captures. Close the message with: Voice note back or ignore. Silence is a valid answer.
