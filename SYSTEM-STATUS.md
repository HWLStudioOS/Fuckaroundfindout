...
- The separate Better at Work public-site branch now uses patched PostCSS 8.5.25 and Sharp 0.35.3. Its npm lock includes complete cross-platform optional-package metadata. Clean install, content verification, typecheck, the 98-page build and low-threshold audit pass locally and in GitHub Actions. Its Actions are pinned to immutable commits. It remains an unmerged draft and production is unchanged.
