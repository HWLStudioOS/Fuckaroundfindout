...
- **Redeploy creepers-content-calendar.vercel.app from the mini.** CSV at `business/clients/creepers-calendar-2026-jun-sep.csv` was edited on the laptop. W2 changes: Mon (22 June, Sales desk) deleted; Tue (23 June, Root ball and crane) source switched from New Forest to Surrey; Thu (25 June, S1 macro set) deleted. The live site reads from `~/creepers-content-calendar/` on the mini, not the CSV — on return to the mini, sync the CSV change into the app data and redeploy. Same URL.
